...
export const fullListQO = () =>
  queryOptions({
    queryKey: fullListQK(),
    queryFn: ({ signal }) => RecipeEmployeeRefAPI.fullList(signal),
...
export const listQO = (params: PageDto) =>
  queryOptions({
    ...
    queryFn: ({ signal }) => RecipeEmployeeRefAPI.list(params, signal),
    placeholderData: keepPreviousData
  })
...
export const detailQO = (id?: string) =>
  queryOptions({
    ...
    queryFn: ({ signal }) => RecipeEmployeeRefAPI.detail(id!, signal),
    enabled: !!id
  })
