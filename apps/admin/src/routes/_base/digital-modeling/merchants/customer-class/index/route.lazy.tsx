...
import { type CustomerClassVo, listQO, useDeleteMutation } from '@/features/customer-class'
    ...
    () => [
      ...
      { field: 'iGrade', headerName: '级次' },
      {
        ...
        cellRenderer: (params: ICellRendererParams) => (
          <Space>
            <PermCodeProvider code="customer-class:edit">
              <Button
                size="small"
                color="primary"
                variant="text"
            ...
            <PermCodeProvider code="customer-class:delete">
              <Button
                size="small"
                color="primary"
                variant="text"
        ...
        >
          ...
          >
            ...
            >
              ...
              <Space>
                <PermCodeProvider code="customer-class:add">
                  <Button
                    type="primary"
