...
import { type CustomerVo, listQO, useDeleteMutation } from '@/features/customer'
    ...
    () => [
      ...
      { field: 'cAddress', headerName: '地址' },
      {
        ...
        cellRenderer: (params: ICellRendererParams) => (
          <Space>
            <PermCodeProvider code="customer:edit">
              <Button
                size="small"
                color="primary"
                variant="text"
            ...
            <PermCodeProvider code="customer:delete">
              <Button
                size="small"
                color="primary"
                variant="text"
        ...
        >
          ...
          >
            ...
            >
              ...
              <Space>
                <PermCodeProvider code="customer:add">
                  <Button
                    type="primary"
