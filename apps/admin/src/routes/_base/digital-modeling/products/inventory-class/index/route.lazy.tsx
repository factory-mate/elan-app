...
import { type InventoryClassVo, listQO, useDeleteMutation } from '@/features/inventory-class'

import { AddModal, EditModal, TreeArea } from './-components'
import type { EditModalMeta } from './-types'

export const Route = createLazyFileRoute('/_base/digital-modeling/products/inventory-class/')({
    ...
    () => [
      ...
      { field: 'iGrate', headerName: '级次' },
      {
        ...
        cellRenderer: (params: ICellRendererParams) => (
          <Space>
            <PermCodeProvider code="inventory-class:edit">
              <Button
                size="small"
                color="primary"
                variant="text"
            ...
            <PermCodeProvider code="inventory-class:delete">
              <Button
                size="small"
                color="primary"
                variant="text"
        ...
        >
          ...
          >
            ...
            >
              ...
              <Space>
                <PermCodeProvider code="inventory-class:add">
                  <Button
                    type="primary"
