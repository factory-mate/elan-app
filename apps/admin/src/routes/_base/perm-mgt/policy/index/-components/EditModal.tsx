...
export default function EditModal(props: EditModalProps) {
  ...
  const [form] = Form.useForm<PolicyEditDto>()
  ...
  const { data: detailListData, isPending: isDetailListPending } = useQuery(detailListQO(meta?.UID))
  ...
  const onFinish: FormProps<PolicyEditDto>['onFinish'] = (values) => {
